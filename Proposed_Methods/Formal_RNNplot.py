...
with h5py.File(''.join(['level2/h5file/test'+str(20)+'.h5']), 'r') as hf:
...
model.load_weights('level2/RNN of weight2 of20/weight_LSTM-23-25.50999.hdf5')
...
#prediction_df = prediction_df.loc[(prediction_df["times"].dt.month >11 ),: ]
#ground_true_df = ground_true_df.loc[(ground_true_df["times"].dt.month >11 ),:]
