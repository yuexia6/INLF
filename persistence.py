...
for node in range (1,2):
    if (node!=54):
        series = read_csv('level3/2016years_level3/test'+str(node)+'.csv', header=0,  index_col=0, squeeze=True)
...
final=err.min(0)
err.to_csv('level3/result of the naive forecasting1',header=None,index=False)
bar_width=0.2
