...
model.add(LeakyReLU())
model.load_weights('RNNweight20/Weightweather Lmst.csv-95-15184.65272.hdf5')
...
prediction_df = prediction_df.loc[(prediction_df["times"].dt.month >=7 ),: ]
ground_true_df = ground_true_df.loc[(ground_true_df["times"].dt.month >=7 ),:]
